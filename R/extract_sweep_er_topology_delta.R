# extract_sweep_er_topology_delta.R
# Build only the pre/post differential topology table for ER sweep.
...
run_dir <-
  "outputs/sweep_er/er_2026-03-04"   # ajusta si hace falta
